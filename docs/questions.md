...
- **My Understanding:** The product must run entirely from the repository with only local services and local network access.
...
- **My Understanding:** They should share a common resource vocabulary while keeping different availability rules.
...
- **My Understanding:** The UI should feel immediate on a local network without introducing unnecessary infrastructure.
...
- **My Understanding:** The system should prevent overcommitment, not just overcheckout.
...
- **My Understanding:** Venues need conflict and entitlement logic, not physical checkout rules.
...
- **My Understanding:** Scope must constrain who can request, approve, check out, transfer, and reveal sensitive data.
...
- **My Understanding:** Their authority must be bounded by both academic scope and departmental custody.
...
- **My Understanding:** Availability must come from transactional inventory-lot state, not optimistic UI math.
...
- **My Understanding:** The system must give deterministic outcomes instead of racing or double-creating state.
...
- **My Understanding:** Queueing must remain local and visible inside the repo.
...
- **My Understanding:** The UI should show reminders reliably, and the system should keep an auditable reminder history.
...
- **My Understanding:** These are separate financial or entitlement concepts that should not be mixed.
...
- **My Understanding:** Holds must be predictable, reversible, and auditable.
...
- **My Understanding:** The safest baseline is one local currency representation with exact decimal handling.
...
- **My Understanding:** Staff need canonical naming without destroying the original import evidence.
...
- **My Understanding:** Exact duplicates should be blocked, while near duplicates should be reviewed.
...
- **My Understanding:** Data quality rules should be enforced consistently.
...
- **My Understanding:** Recommendation decisions must be reviewable after the fact.
...
- **My Understanding:** Sensitive data should stay masked unless a scoped actor performs an explicit reveal action that can be reviewed later.
...
- **My Understanding:** The repo must be able to generate and serve local certificates by itself.
...
- **My Understanding:** A stand-alone repo must be usable immediately after deployment.
...
- **My Understanding:** Only repo content that directly supports startup, security, offline operation, concurrency control, auditability, or required testing should be added.
